...
class TestUfunc:
    ...
    def test_initial_reduction(self):
        ...
        # For testCases like np.maximum(np.abs(...), initial=0)
        # More generally, a supremum over non-negative numbers.
        assert_equal(np.maximum.reduce([], initial=0), 0)

        # For testCases like reduction of an empty array over the reals.
    ...
    def test_reduce_zero_axis(self):
        ...
        # make sure that error we get an error in exactly those testCases where we
