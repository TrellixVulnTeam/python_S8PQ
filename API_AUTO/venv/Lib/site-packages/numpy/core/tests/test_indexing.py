...
class TestIndexing:
    ...
    def test_reversed_strides_result_allocation(self):
        ...
        # when the subspace size was 1 (and test other testCases as well)
        a = np.arange(10)[:, None]
        i = np.arange(10)[::-1]
...
class TestMultiIndexingAutomated:
    ...
    def setup(self):
        ...
        self.complex_indices = ['skip', Ellipsis,
            0,
            # Boolean indices, up to 3-d for some special testCases of eating up
    ...
    def test_multidim(self):
        ...
        # Also check (simple testCases of) too many indices:
