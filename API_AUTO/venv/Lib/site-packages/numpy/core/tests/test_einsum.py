...
class TestEinsum:
    ...
    def test_einsum_all_contig_non_contig_output(self):
        ...
        # special testCases do not catch the operation before:
        out = np.ones((2, 2, 2))[..., 0]
    ...
    def test_index_transformations(self):
        # Simple index transformation testCases
    ...
    def test_edge_cases(self):
        # Difficult edge testCases for optimization
    ...
    def test_broadcasting_dot_cases(self):
        # Ensures broadcasting testCases are not mistaken for GEMM
