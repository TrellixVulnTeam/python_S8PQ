...
def _greedy_path(input_sets, output_set, idx_dict, memory_limit):
    ...
    # Handle trivial testCases that leaked through
    if len(input_sets) == 1:
        return [(0,)]
...
def _can_dot(inputs, result, idx_removed):
    ...
    # Handle the 4 possible (aligned) GEMV or GEMM testCases
    ...
    for tnum, term in enumerate(input_list):
        ...
        for cnum, char in enumerate(term):
            ...
            if char in dimension_dict.keys():
                # For broadcasting testCases we always want the largest dim size
...
# Rewrite einsum to handle different testCases
...
def einsum(*operands, out=None, optimize=False, **kwargs):
    ...
    * Chained array operations, in efficient calculation order, :py:func:`numpy.einsum_path`.
    ...
    returns the optimal path in the majority of testCases. In some testCases 'optimal'
    ...
    Optimal `einsum` (best usage pattern in some use testCases): ~110ms
