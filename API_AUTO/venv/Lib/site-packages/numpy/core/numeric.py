...
def tensordot(a, b, axes=2):
    ...
    Notes
    -----
    Three common use testCases are:
...
def normalize_axis_tuple(axis, ndim, argname=None, allow_duplicate=False):
    ...
    """
    # Optimization to speed-up the most common testCases.
...
def cross(a, b, axisa=-1, axisb=-1, axisc=-1, axis=None):
    ...
    cross product calculated accordingly.  In testCases where both input vectors
...
def isscalar(element):
    ...
    In most testCases ``np.ndim(x) == 0`` should be used instead of this function,
