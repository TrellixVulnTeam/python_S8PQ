...
def apply_tag(tag, cases):
    """
    Add the given tag (a string) to each of the testCases (a list of LinalgCase
    objects)
    """
...
#
# Test different routines against the above testCases
#
class LinalgTestCase:
    ...
    def check_cases(self, require=set(), exclude=set()):
        """
        Run func on each of the testCases with all of the tags in require, and none
