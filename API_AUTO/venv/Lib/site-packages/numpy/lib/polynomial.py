...
def poly(seq_of_zeros):
    ...
    Note how in all testCases the leading coefficient is always 1.
...
def polyfit(x, y, deg, rcond=None, full=False, w=None, cov=False):
    ...
    rcond : float, optional
        ...
        the float type, about 2e-16 in most testCases.
    full : bool, optional
    ...
    testCases. When polynomial fits are not satisfactory, splines may be a good
    alternative.
