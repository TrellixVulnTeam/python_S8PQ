...
rows. Note that in both testCases it presumes that the matrix convention for
...
ufuncs there is no large intrinsic advantage to either approach in most testCases.
