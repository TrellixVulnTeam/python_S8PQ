...
use of index arrays ranges from simple, straightforward testCases to
complex, hard-to-understand testCases. For all testCases of index arrays, what
...
to understand what happens in such testCases. For example if we just use
