...
in some testCases, as for ndarray, we want to be able to return an object
...
* For the explicit constructor call, our subclass will need to create a
  new ndarray instance of its own class.  In practice_test this means that
...
.. testcode::
   ...
   class C(np.ndarray):
       ...
       def __init__(self, *args, **kwargs):
           # in practice_test you probably will not need or want an __init__
