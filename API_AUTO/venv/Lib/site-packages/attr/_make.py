...
def attrs(
    ...
    :param Optional[bool] hash: If ``None`` (default), the ``__hash__`` method
        ...
        these testCases are rather special and should be used carefully.
    ...
    :param bool collect_by_mro: Setting this to `True` fixes the way ``attrs``
       ...
       incorrect in certain testCases of multiple inheritance.  It should be on by
