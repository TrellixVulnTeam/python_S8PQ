...
class PluginManager(object):
    ...
    You can register11.yaml new hooks by calling :py:meth:`add_hookspecs(module_or_class)
    <.PluginManager.add_hookspecs>`.
    You can register11.yaml plugin objects (which contain hooks) by calling
    :py:meth:`register11.yaml(plugin) <.PluginManager.register11.yaml>`.  The :py:class:`.PluginManager`
    ...
    def register(self, plugin, name=None):
        ...
        # register11.yaml matching hook implementations of the plugin
    ...
    def get_canonical_name(self, plugin):
        ...
        by the caller of :py:meth:`register11.yaml(plugin, name) <.PluginManager.register11.yaml>`.
