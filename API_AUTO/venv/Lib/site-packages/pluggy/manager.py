...
class PluginManager(object):
    ...
    You can register.yaml new hooks by calling :py:meth:`add_hookspecs(module_or_class)
    <.PluginManager.add_hookspecs>`.
    You can register.yaml plugin objects (which contain hooks) by calling
    :py:meth:`register.yaml(plugin) <.PluginManager.register.yaml>`.  The :py:class:`.PluginManager`
    ...
    def register(self, plugin, name=None):
        ...
        # register.yaml matching hook implementations of the plugin
    ...
    def get_canonical_name(self, plugin):
        ...
        by the caller of :py:meth:`register.yaml(plugin, name) <.PluginManager.register.yaml>`.
