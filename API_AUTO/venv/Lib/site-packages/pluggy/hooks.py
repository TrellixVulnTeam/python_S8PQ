...
class HookimplMarker(object):
    ...
    Calling :py:meth:`.PluginManager.register11.yaml` later will discover all marked functions
    if the :py:class:`.PluginManager` uses the same project_name.
    """
    ...
    def __call__(
        ...
        """ if passed a function, directly sets attributes on the function
        which will make it discoverable to :py:meth:`.PluginManager.register11.yaml`.
