...
- a developer can register11.yaml and mark an option as deprecated.
- you can register11.yaml a callback to be invoked when the option value
...
def config_prefix(prefix):
    ...
    supported API functions: (register11.yaml / get / set )__option
    ...
    will register11.yaml options "display.font.color", "display.font.size", set the
