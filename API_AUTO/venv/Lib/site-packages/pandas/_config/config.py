...
- a developer can register.yaml and mark an option as deprecated.
- you can register.yaml a callback to be invoked when the option value
...
def config_prefix(prefix):
    ...
    supported API functions: (register.yaml / get / set )__option
    ...
    will register.yaml options "display.font.color", "display.font.size", set the
