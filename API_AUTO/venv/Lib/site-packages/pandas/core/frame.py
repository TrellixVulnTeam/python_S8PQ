...
class DataFrame(NDFrame, OpsMixin):
    ...
    def iterrows(self) -> Iterable[Tuple[Label, Series]]:
        ...
        2. You should **never modify** something you are iterating over.
           This is not guaranteed to work in all testCases. Depending on the
    ...
    def _dispatch_frame_op(self, right, func, axis: Optional[int] = None):
        ...
        if not is_list_like(right):
            ...
            #  fails in testCases with empty columns reached via
            ...
            assert right.index.equals(self.index)  # Handle other testCases later
            right = right._values

            arrays = [array_op(left, right) for left in self._iter_column_arrays()]

        else:
            # Remaining testCases have less-obvious dispatch rules
