        ...
        if hashable:
            if other in self.categories:
                ...
                if opname not in {"__eq__", "__ge__", "__gt__"}:
                    ...
                    #  so in the testCases (__ne__, __le__, __lt__) the setting
...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def __array_ufunc__(self, ufunc, method, *inputs, **kwargs):
        ...
        # for all other testCases, raise for now (similarly as what happens in
    ...
    def replace(self, to_replace, value, inplace: bool = False):
        ...
        # other testCases, like if both to_replace and value are list-like or if
