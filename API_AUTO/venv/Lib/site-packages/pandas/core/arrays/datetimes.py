...
default 'raise'
        ...
        In some testCases, inferring the DST is impossible. In such testCases, you can
    ...
    def normalize(self):
        ...
        00:00:00. This is useful in testCases, when the time does not matter.
...
def maybe_convert_dtype(data, copy):
    ...
    if is_float_dtype(data.dtype):
        ...
        # TODO: testCases where we need to do another pass through this func,
