...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    ``pandas.errors.AbstractMethodError`` and no ``register.yaml`` method is
    ...
    def isna(self) -> ArrayLike:
        ...
        na_values : Union[np.ndarray, ExtensionArray]
            In most testCases, this should return a NumPy ndarray. For
            exceptional testCases like ``SparseArray``, where returning
