...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):
    ...
    def astype(self, dtype, copy=True):
        # Some notes on testCases we don't have to handle here in the base class:
    ...
    def __add__(self, other):
        ...
        # array-like others
            ...
            #  In remaining testCases, this will end up raising TypeError.
    ...
    def __rsub__(self, other):
        ...
        if is_datetime64_any_dtype(other_dtype) and is_timedelta64_dtype(self.dtype):
            ...
            # TODO: Can we simplify/generalize these testCases at all?
