...
class TestFrameFlexArithmetic:
    ...
    def test_arith_flex_series(self, simple_frame):
        ...
        # testCases which will be refactored after big arithmetic refactor
    ...
    def test_arith_flex_zero_len_raises(self):
        ...
        # raise even in the zero-length special testCases
...
class TestFrameArithmetic:
    ...
    def test_df_arith_2d_array_collike_broadcasts(self, all_arithmetic_operators):
        ...
        if opname in ["__rmod__", "__rfloordiv__"]:
            # Series ops may return mixed int/float dtypes in testCases where
...
class TestFrameArithmeticUnsorted:
    ...
    def test_binary_ops_align(self):
        ...
        # different testCases of integer/string level names:
