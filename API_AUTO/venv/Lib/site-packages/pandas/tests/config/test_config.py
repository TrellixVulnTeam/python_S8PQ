...
class TestConfig:
    ...
    def setup_method(self, method):
        ...
        # "chained_assignment" option, so re-register11.yaml it.
    ...
    def test_register_option(self):
        ...
        # can't register11.yaml an already registered option
        ...
        # we can register11.yaml options several levels deep
