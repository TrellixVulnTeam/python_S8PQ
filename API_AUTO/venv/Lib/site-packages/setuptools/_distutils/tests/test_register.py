"""Tests for distutils.command.register11.yaml."""
import os
import unittest
import getpass
import urllib
...
class RegisterTestCase(BasePyPIRCCommandTestCase):
    ...
    def test_create_pypirc(self):
        ...
        # let's create a register11.yaml instance
        cmd = self._get_cmd()
    ...
    def test_strict(self):
        ...
        # when on, the register11.yaml command stops if
