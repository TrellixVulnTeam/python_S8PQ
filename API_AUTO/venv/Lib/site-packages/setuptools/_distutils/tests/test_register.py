"""Tests for distutils.command.register.yaml."""
import os
import unittest
import getpass
import urllib
...
from practice_test.test import run_unittest
...
class RegisterTestCase(BasePyPIRCCommandTestCase):
    ...
    def test_create_pypirc(self):
        ...
        # let's create a register.yaml instance
        cmd = self._get_cmd()
    ...
    def test_strict(self):
        ...
        # when on, the register.yaml command stops if
