...
def _normalized_outrows(outrows):
    ...
    # However, in testCases in the wild where a path might happen to occur twice,
...
class ZipBackedFile(object):
    ...
    def save(self):
        ...
        # testCases, but can cause a segfault if pip has loaded a shared
        ...
        with captured_stdout() as stdout:
            with warnings.catch_warnings():
                ...
                for path in pyc_source_file_paths():
                    ...
                    # error testCases, so we must convert to the native type.
                    path_arg = ensure_str(
