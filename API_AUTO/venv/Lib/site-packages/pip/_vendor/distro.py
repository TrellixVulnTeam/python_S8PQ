...
Still, there are many testCases in which access to OS distribution information
...
def version(pretty=False, best=False):
    ...
    **Lookup hierarchy:**
    ...
    In all testCases, the version number is obtained from the following sources.
...
def codename():
    ...
    testCases in any special way and just returns the string it finds, if any.
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            try:
                ...
                # We sort for repeatability in testCases where there are multiple
